...
class VisiteurType extends AbstractType
{
    public function buildForm(FormBuilderInterface $builder, array $options)
    {
        $builder
            ...
            ->add('prenom',TextType::class, array('label' => 'Prenom :','attr'=>
                array('class'=>'form-control','placeholder'=>'')))
            ->add('adresse',TextType::class, array('label' => 'Adresse :','attr'=>
                array('class'=>'form-control','placeholder'=>'')))
            ->add('telephone',TextType::class, array('label' => 'Telephone :','attr'=>
                array('class'=>'form-control','placeholder'=>'')))
